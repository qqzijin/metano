...
def extract_observations(user_id: str, conversation_text: str) -> list[dict]:
    ...
    try:
        ...
        system = 'You are a user modeling assistant. Analyze the conversation and extract observations about the user.\nReturn a JSON array of observations, each with:\n- "content": what you observed about the user (e.g., preference, knowledge, habit, goal)\n- "category": one of "preference", "knowledge", "habit", "goal", "personality", "general"\n- "confidence": 0.0-1.0 how confident you are\n\nOnly extract meaningful observations, not trivial ones. Return empty array if nothing notable.'
